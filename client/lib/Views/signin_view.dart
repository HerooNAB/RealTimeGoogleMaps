...
class _SignInViewState extends State<SignInView> {
  ...
  String _phone = '', _password = '', _role;
  TextEditingController _phoneController,
      _passwordController = TextEditingController();
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  bool _signInSuccess = true;
  String checkRole;
  ...
  Widget build(BuildContext context) {
    //Signin Method + chuyen qua trang homeview sau khi signin
     _submit() {
      ...
      setState(() {
        if(_signInSuccess && checkRole == _role){
        AuthService.signInService(_phone, _password, _role);
        Navigator.push(context, MaterialPageRoute(builder: (context) {
        return HomeView();
      }));
      return ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Signin Successfully')));
      }
      else{
        return ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Signin Failed'),));
      }
      });
