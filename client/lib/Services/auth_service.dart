...
class AuthService{
  static Future<String> signupService(name, email, phone, password, role) async {
  ...
  static Future<String> signInService(phone, password, role) async {
    //SharedPreferences prefs = await SharedPreferences.getInstance();
    String apiUrl = '$URL_SIGNIN';
   
    http.Response response =
        await http.post(apiUrl, body: {'phone': phone, 'password': password, 'role': "User"});
    if(response.statusCode == 200) {
